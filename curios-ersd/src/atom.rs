...
//!
//! Every operand position in the representation holds an [`Atom`]: a reference to a bound value, a bound function, or an interned constant. Compound computation never nests — it is bound by a statement first (the operand law's structural half).
