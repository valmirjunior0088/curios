...
pub(super) fn operation_intrinsic(operation: Operation) -> curios_cont::Intrinsic {
    ...
    match operation {
        ...
        O::FltAdd => curios_cont::Intrinsic::FltAdd,
        O::FltSub => curios_cont::Intrinsic::FltSub,
        O::FltMul => curios_cont::Intrinsic::FltMul,
        O::FltDiv => curios_cont::Intrinsic::FltDiv,
        ...
        O::FltSqrt => curios_cont::Intrinsic::FltSqrt,
        O::FltFloor => curios_cont::Intrinsic::FltFloor,
        O::FltCeil => curios_cont::Intrinsic::FltCeil,
        O::FltTrunc => curios_cont::Intrinsic::FltTrunc,
        O::FltNearest => curios_cont::Intrinsic::FltNearest,
        O::NatToInt => curios_cont::Intrinsic::NatToInt,
        O::NatToFlt => curios_cont::Intrinsic::NatToFlt,
        O::IntToNat => curios_cont::Intrinsic::IntToNat,
        O::IntToFlt => curios_cont::Intrinsic::IntToFlt,
