//! The recipes, and the vocabulary they are written in: where the workspace and its build products live, how a command is run and echoed, and the copy discipline every filed artifact shares.
//!
