//! What erasure deletes — type- and proof-valued parameters, fields, payloads and indices — and the runtime arities both sides of the seam agree on once they are gone.
