//! The program reaching outside itself: streams, files, the terminal, serial ports, the process surface, the network, and the foreign declarations that bind to a host.
//!
