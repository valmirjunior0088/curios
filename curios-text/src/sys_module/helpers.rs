...
// A `Byte` literal value term, for a wire code that is a byte on both sides.
pub(super) fn byte_lit(n: u8) -> Term {
    intrinsic(Intrinsic::Byte(n))
}
...
pub(super) fn nat_lit(n: u64) -> Term {
    match n {
