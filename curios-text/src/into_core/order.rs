...
//!
//! A stable Kahn pass keeps independent declarations in source order; a genuine value cycle leaves nodes unorderable, which are emitted in source order and rejected downstream as unbound names — there is nothing to repair, as cross-declaration value recursion is unexpressible by construction.
//!
