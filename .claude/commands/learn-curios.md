...
allowed-tools: Read, Write, Edit, Grep, Glob, Bash(rg:*), Bash(make:*), Bash(cargo:*), Bash(curios:*), Bash(./target/release/curios:*), Bash(git status:*), Bash(gh release:*), Bash(curl:*), Bash(sh:*), Bash(command:*), Bash(mkdir:*), Bash(ls:*), Bash(cat:*), Bash(rm .learn/:*)
---
