...
- **Wrong answers.** The toolchain misbehaving — a fold that wraps where it must refuse, a cache consulted after its inputs changed, a diagnostic naming the wrong fault, the wrong span, or too little for the reader to act on. Demonstrate with a scratch program or test before presenting; a plausible story is not a find.
