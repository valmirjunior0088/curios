...
- [ ] [Cached user modules](roadmap/compiler/12_CACHED_MODULES_SPEC.md) (an elaborated module and its verdict cached and replayed as scope, once *Binder identity* is defended for independently elaborated modules composed pairwise; parallel per-item certification is deferred there with its measurement)
