...
Five stages: the executable core, the binary64 boundary, exact decimals, the laws, and the boundary proofs. The first four each land alone; the fifth waits on a statement no specification carries at present, as its section says.
