...
- [ ] [A refused law is lifted as a row moving, at every carrier](roadmap/refused-laws-spec.md) (De Morgan and absorption, a map by a function convertible to the identity, and a position inside a window are refused today; not refined yet)
