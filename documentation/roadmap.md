...
- [ ] Developer tooling
  ...
  - [ ] [A claim over a domain nobody enumerated](roadmap/property-testing-spec.md) (not refined yet — shipped once as `test name(params)` probed over drawn arguments, removed because the declaration's quantifier and the report's disagreed; a parameterized test is now a theorem or a refusal)
