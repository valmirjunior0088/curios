...
- [ ] [A refused law is lifted as a row moving, at every carrier](roadmap/refused-laws-spec.md) (De Morgan and absorption, and a map by a function convertible to the identity, are refused today; not refined yet)
