...
- Follows the landed native-width codec (`curios-prelude/std/Toml.crs`, which documents its contract and product limits) and preserves the `Toml` module's ownership and public API shape.
