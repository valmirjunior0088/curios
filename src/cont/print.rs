...
fn print_code<'a>(op: &'a Code) -> Printer<'a> {
    match op {
        ...
        Code::NatToStr(operand) => flat([pure("Nat.to_str"), pure(" "), print_value_name(operand)]),
        ...
        Code::IntToStr(operand) => flat([pure("Int.to_str"), pure(" "), print_value_name(operand)]),
    ...
    match tail {
        ...
        Tail::Host(host) => match host {
            ...
            HostTarget::IoConnect {
                ...
                pure(" "),
                print_value_name(connect_timeout),
                pure(" "),
                print_value_name(read_timeout),
                pure(" "),
                print_value_name(write_timeout),
                pure(" "),
                print_block_name(resume),
            ]),
