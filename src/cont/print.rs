...
fn print_code<'a>(op: &'a Code) -> Printer<'a> {
    match op {
        ...
        Code::BlnEql => pure("bln.eql"),
        Code::BlnNeq => pure("bln.neq"),
        Code::NatEql => pure("nat.eql"),
        Code::NatNeq => pure("nat.neq"),
        Code::NatAdd => pure("nat.add"),
        Code::NatSub => pure("nat.sub"),
        Code::NatMul => pure("nat.mul"),
        Code::NatLt => pure("nat.lt"),
        Code::NatDiv => pure("nat.div"),
        Code::NatRem => pure("nat.rem"),
        Code::NatGt => pure("nat.gt"),
        Code::NatLte => pure("nat.lte"),
        Code::NatGte => pure("nat.gte"),
        Code::IntEql => pure("int.eql"),
        Code::IntNeq => pure("int.neq"),
        Code::IntAdd => pure("int.add"),
        Code::IntSub => pure("int.sub"),
        Code::IntMul => pure("int.mul"),
        Code::IntNeg => pure("int.neg"),
        Code::IntDiv => pure("int.div"),
        Code::IntRem => pure("int.rem"),
        Code::IntLt => pure("int.lt"),
        Code::IntGt => pure("int.gt"),
        Code::IntLte => pure("int.lte"),
        Code::IntGte => pure("int.gte"),
        Code::FltAdd => pure("flt.add"),
        Code::FltSub => pure("flt.sub"),
        Code::FltMul => pure("flt.mul"),
        Code::FltDiv => pure("flt.div"),
        Code::FltEql => pure("flt.eql"),
        Code::FltNeq => pure("flt.neq"),
        Code::FltLt => pure("flt.lt"),
        Code::FltGt => pure("flt.gt"),
        Code::FltLte => pure("flt.lte"),
        Code::FltGte => pure("flt.gte"),
        Code::FltMin => pure("flt.min"),
        Code::FltMax => pure("flt.max"),
        Code::FltNeg => pure("flt.neg"),
        Code::FltAbs => pure("flt.abs"),
        Code::FltSqrt => pure("flt.sqrt"),
        Code::FltFloor => pure("flt.floor"),
        Code::FltCeil => pure("flt.ceil"),
        Code::FltTrunc => pure("flt.trunc"),
        Code::FltNearest => pure("flt.nearest"),
        Code::NatToInt => pure("nat.to_int"),
        Code::IntToNat => pure("int.to_nat"),
        Code::IntToFlt => pure("int.to_flt"),
