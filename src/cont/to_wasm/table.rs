...
pub struct Table<'a> {
    ...
    sys_read: OnceCell<wasm::FuncName>,
...
impl<'a> Table<'a> {
    ...
    pub fn sys_read_func(&self) -> &wasm::FuncName {
        self.sys_read
            .get_or_init(|| wasm::FuncName::from("sys_read"))
    }

    pub fn sys_read_used(&self) -> bool {
        self.sys_read.get().is_some()
    }
