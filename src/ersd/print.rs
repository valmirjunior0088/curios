...
fn print_pure_prim<'a>(prim: &'a PurePrim) -> Printer<'a> {
    match prim {
        ...
        PurePrim::NatToStr(t) => print_unary("Nat.to_str", t),
        ...
        PurePrim::IntToStr(t) => print_unary("Int.to_str", t),
        ...
        PurePrim::FltToStr(t) => print_unary("Flt.to_str", t),
...
fn print_host_prim<'a>(prim: &'a HostPrim) -> Printer<'a> {
    match prim {
        ...
        HostPrim::IoResolve(h, p) => print_binary("Io.resolve", h, p),
        ...
        HostPrim::IoStartTls(h, s) => print_binary("Io.start_tls", h, s),
        HostPrim::IoTlsServerConfig(c, k) => print_binary("Io.tls_server_config", c, k),
        HostPrim::IoStartTlsServer(h, c) => print_binary("Io.start_tls_server", h, c),
