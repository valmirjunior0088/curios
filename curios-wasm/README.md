...
It also keeps the emitter honest about ordering: because the encoder assigns indices from declaration order, `curios-emit` may emit items in whatever order its lowering finds natural, and the two concerns never negotiate.
