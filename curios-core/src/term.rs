    ...
    pub fn head_key(&self) -> Option<HeadTag<'_>> {
        match &self.inner.subterm {
            ...
            Subterm::Intrinsic(intrinsic) => match intrinsic {
                ...
                Intrinsic::NatGe(..) => Some(HeadTag::Intrinsic("intrinsic:NatGe")),
                ...
                Intrinsic::ByteGe(..) => Some(HeadTag::Intrinsic("intrinsic:ByteGe")),
                ...
                Intrinsic::IntGe(..) => Some(HeadTag::Intrinsic("intrinsic:IntGe")),
                ...
                Intrinsic::FltGe(..) => Some(HeadTag::Intrinsic("intrinsic:FltGe")),
