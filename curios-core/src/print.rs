...
fn print_prim(prim: Prim, depth: usize) -> Printer<'static> {
    match prim {
        ...
        Prim::NatRotl(l, r) => print_binary("Nat.rotl ", l, r, depth),
        Prim::NatRotr(l, r) => print_binary("Nat.rotr ", l, r, depth),
        Prim::NatClz(i) => print_unary("Nat.clz ", i, depth),
        Prim::NatCtz(i) => print_unary("Nat.ctz ", i, depth),
        Prim::NatPopcnt(i) => print_unary("Nat.popcnt ", i, depth),
        ...
        Prim::IntRotl(l, r) => print_binary("Int.rotl ", l, r, depth),
        Prim::IntRotr(l, r) => print_binary("Int.rotr ", l, r, depth),
        Prim::IntClz(i) => print_unary("Int.clz ", i, depth),
        Prim::IntCtz(i) => print_unary("Int.ctz ", i, depth),
        Prim::IntPopcnt(i) => print_unary("Int.popcnt ", i, depth),
        ...
        Prim::FltCopysign(l, r) => print_binary("Flt.copysign ", l, r, depth),
