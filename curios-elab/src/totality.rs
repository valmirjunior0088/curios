...
pub fn classify_module(
    ...
    // A name neither defined here nor inherited is treated as total. Every `Global` a zonked module mentions is defined either in it or in the prefix it was spliced onto, so that case is unreachable rather than an approximation.
